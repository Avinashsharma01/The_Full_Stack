...
const Navbar = () => {
    ...
    return (
        <div className="flex sticky top-0 justify-around text-white bg-slate-600 w-full h-[80px] items-center text-lg">
            <div className="logo">
                <h1>Avinash</h1>
            </div>
            <div className="link ">
                <ul className=" flex">
                    ...
                    <li>
                        <NavLink to="/ToyStore" className="p-5 cursor-pointer ">
                            ToyStore
                        </NavLink>
                    </li>
                    <li>
